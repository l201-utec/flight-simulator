...
public class SkyVibration : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int ii = 0; ii < devices.Length; ii++)
        {
            ...
            newPlaneHeight = GameObject.Find("AircraftJet").transform.position.y >= 120;

            if (oldPlaneHeight != newPlaneHeight)
            {
...
public class HapticPlaneEffectEditor : Editor
{
